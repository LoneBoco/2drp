#include "client/loader/spriter/jsonspriterfileelementwrapper.h"
#include "client/loader/spriter/jsonspriterfileattributewrapper.h"
...
SpriterEngine::SpriterFileAttributeWrapper * JSONSpriterFileElementWrapper::newAttributeWrapperFromFirstAttribute()
{
	if(!isValid()) {
...
SpriterEngine::SpriterFileAttributeWrapper * JSONSpriterFileElementWrapper::newAttributeWrapperFromFirstAttribute(const std::string & attributeName)
{
	if(!isValid()) {
...
SpriterEngine::SpriterFileElementWrapper * JSONSpriterFileElementWrapper::newElementWrapperFromFirstElement()
{
	if(!isValid()) {
...
SpriterEngine::SpriterFileElementWrapper * JSONSpriterFileElementWrapper::newElementWrapperFromFirstElement(const std::string & elementName)
{
	if(!isValid()) {
...
SpriterEngine::SpriterFileElementWrapper * JSONSpriterFileElementWrapper::newElementWrapperFromNextSiblingElement()
{
...
SpriterEngine::SpriterFileElementWrapper * JSONSpriterFileElementWrapper::newElementClone()
{
